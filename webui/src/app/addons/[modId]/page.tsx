      ...
      {addon && (
        <>
          ...
          <div className="mc-window p-4 mb-4">
            <div className="flex gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <span className="mc-category text-aqua">{formatCount(addon.downloadCount)} downloads</span>
            ...
            <p className="mc-gray mt-4 p-2 bg-black/20 border-l-2 border-mc-gold/50" style={{ fontSize: 11, lineHeight: 1.5 }}>
              {addon.summary}
            </p>
          ...
          {showWorldPicker && (
            <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: "rgba(0,0,0,0.6)" }}>
              <div className="mc-window p-4 w-80">
                ...
                {addon.screenshots.length > 1 && (
                  <div className="flex justify-center gap-1.5 mt-2 overflow-x-auto pb-1">
                    {addon.screenshots.map((s, i) => (
                      <button
                        key={i}
                        className={`w-10 h-10 flex-shrink-0 border-2 ${i === screenshotIdx ? "border-mc-aqua" : "border-black/50"}`}
          ...
          <div className="mc-dark-panel p-4 mb-4">
            <div className="mc-section mb-3 border-b border-black/20 pb-1">Detailed Description</div>
            <div
                ...
                <div key={file.id} className="mc-row flex items-center justify-between px-3 py-2.5">
                  <div className="flex-1 min-w-0 mr-3">
                    ...
                    <div className="mc-dark-gray flex gap-3 mt-0.5" style={{ fontSize: 9 }}>
                      ...
                      <span className="text-[8px] opacity-50">{new Date(file.fileDate).toLocaleDateString()}</span>
                    </div>
                  </div>
                  <button
